...
export const TechStack = () => {
	const techStack: TechItem[] = [
		...
		{
			title: "Vercel",
			icon: "vercel", // Replace with Vercel icon when available
		...
		{
			title: "Better Auth",
			icon: "betterAuth", // Replace with Better Auth icon when available
	...
	return (
		<div className="py-6">
			...
			<div className="relative w-full">
				<div className="absolute inset-0">{renderGridIntersections()}</div>
				<div
